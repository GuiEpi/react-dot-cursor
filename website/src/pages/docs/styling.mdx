...
### <a name="see-it-live"></a>See it live

Hover each element and watch the cursor adapt. No configuration involved, this is all default behavior:

<div className="flex flex-wrap items-center gap-4 not-prose my-6">
  <button className="rounded-md border px-4 py-2" type="button">
    A button
  </button>
  <a className="underline underline-offset-4" href="#see-it-live">
    A link
  </a>
  <button className="rounded-md border px-4 py-2" type="button" disabled>
    Disabled
  </button>
  <div className="rounded-md border border-dashed px-4 py-2" role="button">
    role="button"
  </div>
